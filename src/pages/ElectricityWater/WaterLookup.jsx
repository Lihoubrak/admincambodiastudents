...
const WaterLookup = () => {
  ...
  const fetchWater = async () => {
    try {
      setLoading(true);
      const waterRes = await TokenRequest.get(
        `/waters/v8/all?month=${selectedMonth || month}&year=${
  ...
  return (
    <div className="max-w-6xl mx-auto bg-white p-8 border border-gray-300 shadow-md rounded-md relative">
      <div className="text-7xl ml-20 font-semibold mb-6 text-gray-700">
        <FaHandHoldingWater />
      </div>
